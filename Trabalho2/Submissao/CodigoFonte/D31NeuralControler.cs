...
public class D31NeuralControler : MonoBehaviour
{
    ...
    /* -- Todo o pseudo-codigo das funcoes fitness utilizadas consta devidamente documentado no relatorio. -- */
    ...
    public float GetScoreBlue()
    {
        ...
        float fitness = 0;
        fitness += (float)85 * (1 / (10 * distanceToBall.Average()));
        fitness -= 200 * GoalsOnMyGoal;
        if (GoalsOnMyGoal == 0)
            fitness += 1000;
        DebugLog("BLUE");
        return fitness;
